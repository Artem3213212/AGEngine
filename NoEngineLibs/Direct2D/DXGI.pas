{**********************************************************************
 ...
 Microsoft DirectX Graphics Infrastructure (DXGI) API
***********************************************************************}
...
type
  ...
  IDXGIResource=interface(IDXGIDeviceSubObject)
    ...
    (
      out SharedHandle:THANDLE    
    ):HResult; stdcall;

    function GetUsage
    (
      out Usage:TDXGI_Usage    
    ):HResult; stdcall;

    function SetEvictionPriority
    (
      EvictionPriority:LongWord  
    ):HResult; stdcall;

    function GetEvictionPriority
    (
      out EvictionPriority:LongWord    
    ):HResult; stdcall;
  end;
  ...
  IDXGISurface=interface(IDXGIDeviceSubObject)
    ...
    function GetDesc
    (
      out Desc:TDXGI_SurfaceDesc    
    ):HResult; stdcall;

    function Map
    (
      out LockedRect:TDXGI_MappedRect;    
      MapFlags:LongWord  
    ):HResult; stdcall;
  ...
  IDXGIAdapter=interface(IDXGIObject)
    ...
    function GetDesc
    (
      out Desc:TDXGI_AdapterDesc    
    ):HResult; stdcall;

    function CheckInterfaceSupport
    (
      const InterfaceName:TGUID;    
      out UMDVersion:LARGE_INTEGER    
    ):HResult; stdcall;
  end;
  ...
  IDXGIOutput=interface(IDXGIObject)
    ...
    function GetDesc
    (
      out Desc:TDXGI_OutputDesc    
    ):HResult; stdcall;

    function GetDisplayModeList
    (
      EnumFormat:TDXGI_Format;  
      Flags:LongWord;  
      var NumModes:LongWord;
      pDesc:PTDXGI_ModeDesc  
    ):HResult; stdcall;

    function FindClosestMatchingMode
    (
      const ModeToMatch:TDXGI_ModeDesc;    
      out ClosestMatch:TDXGI_ModeDesc;    
    ...
    (
      out GammaCaps:TDXGI_GammaControlCapabilities    
    ):HResult; stdcall;

    function SetGammaControl
    (
      const _Array:TDXGI_GammaControl    
    ):HResult; stdcall;

    function GetGammaControl
    (
      out _Array:TDXGI_GammaControl    
    ):HResult; stdcall;

    function SetDisplaySurface
    (
      ScanoutSurface:IDXGISurface    
    ):HResult; stdcall;

    function GetDisplaySurfaceData
    (
      Destination:IDXGISurface    
    ):HResult; stdcall;

    function GetFrameStatistics
    (
      out Stats:TDXGI_FrameStatistics    
    ):HResult; stdcall;
  end;
  ...
  IDXGISwapChain=interface(IDXGIDeviceSubObject)
    ...
    (
      out Fullscreen:LongBool;    
      out Target:IDXGIOutput    
    ):HResult; stdcall;

    function GetDesc
    (
      out Desc:TDXGI_SwapChainDesc    
    ):HResult; stdcall;
    ...
    (
      ...
      Width:LongWord;  
      Height:LongWord;  
      NewFormat:TDXGI_Format;  
      SwapChainFlags:LongWord  
    ):HResult; stdcall;

    function ResizeTarget
    (
      const NewTargetParameters:TDXGI_ModeDesc    
    ):HResult; stdcall;
  ...
  IDXGIFactory=interface(IDXGIObject)
    ...
    (
      AdapterIndex:LongWord;  
      out Adapter:IDXGIAdapter    
    ):HResult; stdcall;
    ...
    (
      out WindowHandle:HWND    
    ):HResult; stdcall;

    function CreateSwapChain
    (
      Device:IUnknown;    
      const Desc:TDXGI_SwapChainDesc;    
  ...
  IDXGIDevice=interface(IDXGIObject)
    ...
    function GetAdapter
    (
      out pAdapter:IDXGIAdapter    
    ):HResult; stdcall;

    function CreateSurface
    (
      const Desc:TDXGI_SurfaceDesc;    
      NumSurfaces:LongWord;  
      Usage:TDXGI_Usage;  
      pSharedResource:PTDXGI_SharedResource;    
      out Surface:IDXGISurface    
    ):HResult; stdcall;

    function QueryResourceResidency
    (
      pResources:PIUnknown;
      pResidencyStatus:PTDXGI_Residency;
      NumResources:LongWord  
    ):HResult; stdcall;
  ...
  IDXGIDevice1=interface(IDXGIDevice)
    ...
    (
      out MaxLatency:LongWord    
    ):HResult; stdcall;
  end;

var CreateDXGIFactory: function(const IID:TGUID;out pFactory):HResult; stdcall;
var CreateDXGIFactory1: function(const IID:TGUID;out pFactory):HResult; stdcall;
