...
type
  ...
  (
    ...
    D2D1_FEATURE_LEVEL_9=Integer($9100),
    D2D1_FEATURE_LEVEL_10=Integer($a000)
  );
...
begin
  ...
  pointer(D2D1CreateFactory):=LinkMethod(hDLL_D2D1,'D2D1CreateFactory',DLL_D2D1);
  pointer(D2D1MakeRotateMatrix):=LinkMethod(hDLL_D2D1,'D2D1MakeRotateMatrix',DLL_D2D1);
  pointer(D2D1MakeSkewMatrix):=LinkMethod(hDLL_D2D1,'D2D1MakeSkewMatrix',DLL_D2D1);
  pointer(D2D1IsMatrixInvertible):=LinkMethod(hDLL_D2D1,'D2D1IsMatrixInvertible',DLL_D2D1);
  pointer(D2D1InvertMatrix):=LinkMethod(hDLL_D2D1,'D2D1InvertMatrix',DLL_D2D1);
end;
